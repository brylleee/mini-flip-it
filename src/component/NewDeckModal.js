...
function NewDeckModal({ onClose, onCreateDeck, onUpdateDeck, editingDeck }) {
    ...
    const handleSave = () => {
        if (deckName.trim()) {
            if (editingDeck) {
                onUpdateDeck(editingDeck._id, deckName, deckDescription);
            } else {
    ...
    return (
        <div id="newDeckModal" className="fixed inset-0 bg-black bg-opacity-60 flex items-center justify-center z-50">
            <div className="bg-[#23272e] rounded-xl p-6 w-full max-w-md slide-in shadow-lg text-[#e6edf3] font-[Ubuntu]">
                <div className="flex justify-between items-center mb-4">
                    <h3 className="text-xl font-semibold text-[#38bdf8]">{editingDeck ? 'Edit Deck' : 'Create New Deck'}</h3>
                ...
                <div className="space-y-4">
                    <div>
                        <label className="block text-[#b1bac4] mb-1" htmlFor="deckNameInput">Deck Name</label>
                        <input
                            type="text"
                            id="deckNameInput"
                    ...
                    <div>
                        <label className="block text-[#b1bac4] mb-1" htmlFor="deckDescriptionInput">Description (Optional)</label>
                        <textarea
                    ...
                    <div className="flex justify-end space-x-3 pt-4">
                        ...
                        <button onClick={handleSave} className="bg-[#38bdf8] hover:bg-[#00bfff] text-[#181a1b] px-4 py-2 rounded-lg transition font-semibold shadow">
